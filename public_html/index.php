...
<section class="section works" id="works"><p class="section-no">03 / WORKS</p><div><div class="section-head"><h2>現場から生まれた、<br>お店づくりの実績。</h2><span>OKINAWA PROJECTS</span></div><div class="work-list"><?php foreach(array_slice(array_reverse($works),0,4) as $work):$workImages=work_images($work);?><a class="home-work-detail-link" href="work-detail.php?id=<?=rawurlencode((string)$work['id'])?>"><article><?php if($workImages):?><span class="placeholder" style="background-image:url(<?=e($workImages[0])?>)"></span><?php else:?><span class="placeholder"></span><?php endif;?><p><?= e($work['category']) ?> / <?= e($work['area']) ?></p><h3><?= e($work['title']) ?></h3><strong>詳しく見る →</strong></article></a><?php endforeach; ?></div><a class="button works-more" href="works.php">地図と施工事例をもっと見る →</a></div></section>
