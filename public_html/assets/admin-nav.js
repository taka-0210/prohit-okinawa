(()=>{
 ...
 const items=[['admin.php','dashboard','ダッシュボード'],['home-admin.php','home','ホーム基本情報'],['admin.php?tab=hero','hero','HEROスライド'],['hero-settings.php','hero-settings','HERO共通設定'],['service-admin.php','services','サービス管理'],['maps-admin.php','maps','地図管理'],['works-admin.php','works','施工事例'],['news-admin.php','news','最新情報'],['inquiries-admin.php','inquiries','お問い合わせ'],['company-admin.php','company','ブランド・会社情報']];
 const current=path==='home-admin.php'?'home':path==='hero-settings.php'?'hero-settings':path==='service-admin.php'?'services':path==='maps-admin.php'?'maps':path==='works-admin.php'?'works':path==='news-admin.php'?'news':path==='inquiries-admin.php'?'inquiries':path==='company-admin.php'?'company':tab;
