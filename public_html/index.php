...
<?php foreach($servicePages as $index=>$servicePage): $serviceCardImage=(string)($servicePage['card_image']??'');?><article data-service-slug="<?=e($servicePage['id'])?>"<?=$serviceCardImage!==''?' class="has-service-image" style="background-image:linear-gradient(rgba(16,42,67,.58),rgba(16,42,67,.68)),url(\''.e($serviceCardImage).'\')"':''?>><span><?=str_pad((string)($index+1),2,'0',STR_PAD_LEFT)?></span><h3><?=e($servicePage['title'])?></h3><p><?=e($servicePage['lead'])?></p></article><?php endforeach; ?>
</div></div></section>
