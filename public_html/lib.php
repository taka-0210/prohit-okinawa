...
function seed_content(): void
{
    ...
    $serviceDetails = [
        'kitchen-design-opening' => [
            'intro' => '飲食店の厨房は、機器を並べるだけでは完成しません。メニュー、席数、スタッフの動き、提供時間、将来の設備更新まで見据え、開業後も使いやすい厨房を計画します。',
            'sections' => [
                ['現地調査から始める', '店舗の広さや設備条件、給排水・電気・ガス・換気の状況を確認し、計画の土台を整えます。'],
                ['動きやすい厨房レイアウト', '調理工程とスタッフの動線を整理し、移動や作業の無駄を抑えた厨房レイアウトをご提案します。'],
                ['図面と見積りで具体化', '機器寸法や作業スペースを図面に落とし込み、新品と中古を組み合わせた現実的な予算を組み立てます。'],
                ['搬入・設置から開業まで', '厨房機器の搬入設置、設備工事との連携、試運転まで進行し、安心して開業日を迎えられるよう伴走します。'],
            ],
        ],
        'equipment-sales-purchase' => [
            'intro' => '新品・中古の厨房機器を、業態や予算、設置条件に合わせてご提案します。買い替えや閉店に伴う買取、撤去についても一つの窓口で対応します。',
            'sections' => [
                ['必要な機器を一緒に整理', 'メニュー、提供数、厨房の広さを確認し、本当に必要な機器と優先順位を整理します。'],
                ['新品と中古を最適に組み合わせる', '性能、耐用年数、予算のバランスを考え、新品と中古から無理のない構成をご提案します。'],
                ['搬入・設置・買取まで対応', '納品時の搬入設置はもちろん、入れ替え機器や閉店時の厨房機器の査定・買取もご相談いただけます。'],
            ],
        ],
        'interior-exterior' => [
            'intro' => '厨房だけでなく、客席やファサードまで店舗全体を一つのコンセプトで整えます。営業のしやすさと、お客様に選ばれる空間づくりを両立します。',
            'sections' => [
                ['現地とご要望を確認', '物件の状態、業態、ターゲット、ご予算を伺い、必要な工事と優先順位を整理します。'],
                ['店舗コンセプトを設計', '料理やサービスの魅力が伝わるよう、客席、照明、素材、サインまで一貫した方向性をつくります。'],
                ['厨房と客席を一体で計画', 'スタッフとお客様の動線を考え、厨房の作業性と客席の快適性を両立するレイアウトに整えます。'],
                ['内装・外装工事を進行', '設備業者や各職種と連携し、工程と品質を管理しながら、開業スケジュールに合わせて工事を進めます。'],
            ],
        ],
        'uriten' => [
            'intro' => '居抜き店舗を手放したい方と、次のお店を始めたい方をつなぎます。現役の飲食店経営者として、物件の紹介だけでなく工事や開業準備まで支援します。',
            'sections' => [
                ['売却・掲載のご相談', '店舗を手放したい方から状況を伺い、設備や内装を活かした居抜き売却の進め方をご案内します。'],
                ['居抜き物件をご紹介', 'これから開業したい方へ、希望する業態・エリア・予算に合わせた物件情報をご紹介します。'],
                ['現地と設備を確認', '内装や厨房設備の状態、追加工事の必要性を確認し、引き継いだ後の費用も含めて検討します。'],
                ['契約後の開業もサポート', '厨房機器の追加・入れ替えや店舗工事まで対応し、物件取得後の開業準備を一貫して支えます。'],
            ],
        ],
        'okinawa-opening' => [
            'intro' => '沖縄本島はもちろん、宮古島・石垣島など離島での飲食店開業にも対応します。地域の環境や商習慣を知る現地チームが、県外からの出店も支援します。',
            'sections' => [
                ['沖縄で実現したい構想を整理', '業態、出店時期、予算、希望エリアを伺い、沖縄での開業に必要な準備を整理します。'],
                ['物件・地域情報を共有', '居抜き店舗を含む物件情報や、観光需要・地域特性を踏まえた出店エリア選びをサポートします。'],
                ['厨房と店舗を現地で計画', '本土側の担当者とも連携し、厨房機器、レイアウト、内外装工事を現地条件に合わせて進めます。'],
                ['本島・離島の開業に伴走', '沖縄本島に加え、宮古島や石垣島などのプロジェクトにも対応し、搬入設置から開業まで支援します。'],
            ],
        ],
        'rational' => [
            'intro' => 'スチームコンベクションオーブンをはじめとするラショナル製品を、実際のメニューとオペレーションに合わせてご提案します。',
            'sections' => [
                ['現在の調理工程を確認', '仕込み、加熱、提供までの流れや課題を伺い、導入によって改善できる工程を整理します。'],
                ['最適な機種と運用をご提案', '調理量、メニュー、設置スペースに合わせて機種を選び、厨房全体で使いやすい運用を計画します。'],
                ['実演を通して効果を確認', '実際の調理をイメージしながら、品質の安定、省力化、提供スピードへの効果を具体的に確認します。'],
                ['設置後の活用をフォロー', '導入して終わりではなく、スタッフが機能を使いこなせるよう、日々の活用と運用改善を支援します。'],
            ],
        ],
    ];
    foreach ($services as &$service) {
        $detail = $serviceDetails[$service['id'] ?? ''] ?? null;
        if (!$detail || (int)($service['content_revision'] ?? 0) >= 1) continue;
